...
function Scene({ paletteUniforms }: { paletteUniforms: PaletteUniforms }) {
  ...
  useFrame((state, delta) => {
    ...
    /* 3. Sphere mouse-follow with bounded attraction (cursor pulls
     * the sphere toward it; falloff with distance keeps the sphere
     * from chasing the cursor across the entire viewport). */
